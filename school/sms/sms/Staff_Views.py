...
from app.models import Staff,Staff_Notification,Staff_leave,Staff_Feedback,Subject,Session_Year,Student,Attendance,Attendance_Report,Student_Result
...
def STAFF_ADD_RESULT(request):
    ...
    if action is not None:
        if request.method == "POST":
            subject_id = request.POST.get('subject_id')
            session_year_id = request.POST.get('session_year_id')
            # print(session_year_id,subject_id)
...
def STAFF_SAVE_RESULT(request):
    if request.method == "POST":
        ...
        if check_exists:
            ...
            result.save()
            messages.success(request,'Result Is Successfuuly Updated..!')
            ...
            result.save()
            messages.success(request,'Result Is Successfuuly Added..!')
            return redirect('staff_add_result')